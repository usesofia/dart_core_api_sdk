...
class BankTransactionTagsApi {
  ...
  Future<Response<BankTransactionTagEntity>> bankTransactionTagsControllerCreateTag({ 
    ...
    try {
      const _type = FullType(CreateBankTransactionTagRequestDto);
      _bodyData = _serializers.serialize(createBankTransactionTagRequestDto, specifiedType: _type);
    ...
    BankTransactionTagEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BankTransactionTagEntity),
      ) as BankTransactionTagEntity;
    ...
    return Response<BankTransactionTagEntity>(
      data: _responseData,
  ...
  Future<Response<BuiltList<BankTransactionTagEntity>>> bankTransactionTagsControllerListTags({ 
    ...
    BuiltList<BankTransactionTagEntity>? _responseData;
    ...
    return Response<BuiltList<BankTransactionTagEntity>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
