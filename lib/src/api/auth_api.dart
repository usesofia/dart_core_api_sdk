...
class AuthApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmailInUseReportEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmailInUseReportEntity>> authControllerGenerateEmailInUseReport({ 
    required GenerateEmailInUseReportRequestDto generateEmailInUseReportRequestDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/iam/auth/email-in-use';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GenerateEmailInUseReportRequestDto);
      _bodyData = _serializers.serialize(generateEmailInUseReportRequestDto, specifiedType: _type);
    ...
    EmailInUseReportEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EmailInUseReportEntity),
      ) as EmailInUseReportEntity;
    ...
    return Response<EmailInUseReportEntity>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [EmailInUseReportEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmailInUseReportEntity>> authControllerGeneratePhoneInUseReport({ 
    required GeneratePhoneInUseReportRequestDto generatePhoneInUseReportRequestDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/iam/auth/phone-in-use';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GeneratePhoneInUseReportRequestDto);
      _bodyData = _serializers.serialize(generatePhoneInUseReportRequestDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserEntity>> authControllerGetMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<CredentialsEntity>> authControllerRefresh({ 
    ...
    final _path = r'/iam/auth/refresh';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [CredentialsEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CredentialsEntity>> authControllerSignInWithEmail({ 
    required SignInWithEmailRequestDto signInWithEmailRequestDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/iam/auth/sign-in/email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SignInWithEmailRequestDto);
      _bodyData = _serializers.serialize(signInWithEmailRequestDto, specifiedType: _type);
