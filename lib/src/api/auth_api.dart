...
class AuthApi {
  ...
  Future<Response<JsonObject>> authControllerCheckEmailInUse({ 
    ...
    final _path = r'/auth/check-email-in-use';
  ...
  Future<Response<void>> authControllerSendEmailVerificationCode({ 
    ...
    final _path = r'/auth/sign-up/email-verification-code';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CredentialsEntity>> authControllerSignInWithEmailPassword({ 
    ...
    final _path = r'/auth/sign-in/email-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserEntity>> authControllerSignUpWithEmailPassword({ 
    ...
    final _path = r'/auth/sign-up/email-password';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
