...
class PluggyApi {
  ...
  Future<Response<PluggyConnectTokenEntity>> pluggyControllerCreateConnectToken({ 
    ...
    try {
      const _type = FullType(CreatePluggyConnectTokenRequestDto);
      _bodyData = _serializers.serialize(createPluggyConnectTokenRequestDto, specifiedType: _type);
    ...
    PluggyConnectTokenEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PluggyConnectTokenEntity),
      ) as PluggyConnectTokenEntity;
    ...
    return Response<PluggyConnectTokenEntity>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> pluggyControllerWebhook({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
