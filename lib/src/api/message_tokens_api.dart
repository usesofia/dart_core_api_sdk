...
class MessageTokensApi {
  ...
  Future<Response<MessageTokenEntity>> messageTokensControllerCreateOrUpdate({ 
    ...
    try {
      const _type = FullType(CreateOrUpdateMessageTokenRequestDto);
      _bodyData = _serializers.serialize(createOrUpdateMessageTokenRequestDto, specifiedType: _type);
    ...
    MessageTokenEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MessageTokenEntity),
      ) as MessageTokenEntity;
    ...
    return Response<MessageTokenEntity>(
      data: _responseData,
  ...
  Future<Response<BuiltList<MessageTokenEntity>>> messageTokensControllerListByWorkspaceId({ 
    ...
    BuiltList<MessageTokenEntity>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(MessageTokenEntity)]),
      ) as BuiltList<MessageTokenEntity>;
    ...
    return Response<BuiltList<MessageTokenEntity>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
