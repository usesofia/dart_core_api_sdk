...
class BankAccountsApi {
  ...
  Future<Response<BankAccountEntity>> bankAccountsControllerActivate({ 
    ...
    final _path = r'/bank/accounts/{bankAccountId}/activate'.replaceAll('{' r'bankAccountId' '}', encodeQueryParameter(_serializers, bankAccountId, const FullType(String)).toString());
  ...
  Future<Response<BankAccountEntity>> bankAccountsControllerCreateOrUpdate({ 
    ...
    try {
      const _type = FullType(CreateOrUpdateBankAccountRequestDto);
      _bodyData = _serializers.serialize(createOrUpdateBankAccountRequestDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BankAccountsBalanceReportEntity>> bankAccountsControllerCreateWorkspaceBalanceReport({ 
    ...
    final _path = r'/bank/workspaces/{workspaceId}/accounts/balance-report'.replaceAll('{' r'workspaceId' '}', encodeQueryParameter(_serializers, workspaceId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BankAccountEntity>> bankAccountsControllerDisable({ 
    ...
    final _path = r'/bank/accounts/{bankAccountId}/disable'.replaceAll('{' r'bankAccountId' '}', encodeQueryParameter(_serializers, bankAccountId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
