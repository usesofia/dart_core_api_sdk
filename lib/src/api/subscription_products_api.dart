...
class SubscriptionProductsApi {
  ...
  const SubscriptionProductsApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<SubscriptionProductEntity>>> subscriptionProductsControllerList({ 
    ...
    BuiltList<SubscriptionProductEntity>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(SubscriptionProductEntity)]),
      ) as BuiltList<SubscriptionProductEntity>;
    ...
    return Response<BuiltList<SubscriptionProductEntity>>(
      data: _responseData,
