...
part 'create_or_update_bank_transactions_in_bulk_request_dto_items_inner_payment_data.g.dart';
...
/// * [receiverReferenceId] 
@BuiltValue()
abstract class CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData implements Built<CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData, CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataBuilder> {
  ...
  CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData._();

  factory CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData([void updates(CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataBuilder b)]) = _$CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData> get serializer => _$CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataSerializer();
}

class _$CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataSerializer implements PrimitiveSerializer<CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData> {
  @override
  final Iterable<Type> types = const [CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData, _$CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData];

  @override
  final String wireName = r'CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData object, {
  ...
  void _deserializeProperties(
    ...
    required CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataBuilder result,
  ...
  @override
  CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerPaymentDataBuilder();
