...
part of 'payment_data_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PaymentDataDto extends PaymentDataDto {
  @override
  ...
  factory _$PaymentDataDto([void Function(PaymentDataDtoBuilder)? updates]) =>
      (new PaymentDataDtoBuilder()..update(updates))._build();
  ...
  @override
  PaymentDataDto rebuild(void Function(PaymentDataDtoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PaymentDataDtoBuilder toBuilder() =>
      new PaymentDataDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PaymentDataDto &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PaymentDataDto')
...
class PaymentDataDtoBuilder
    implements Builder<PaymentDataDto, PaymentDataDtoBuilder> {
  _$PaymentDataDto? _$v;
  ...
  PaymentDataDtoBuilder() {
    PaymentDataDto._defaults(this);
  }

  PaymentDataDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PaymentDataDto other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PaymentDataDto;
  }

  @override
  void update(void Function(PaymentDataDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PaymentDataDto build() => _build();

  _$PaymentDataDto _build() {
    final _$result = _$v ??
        new _$PaymentDataDto._(
            payerName: payerName,
