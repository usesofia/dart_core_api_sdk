...
part of 'bank_transaction_entity_payment_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$BankTransactionEntityPaymentData
    extends BankTransactionEntityPaymentData {
  @override
  final String id;
  @override
  ...
  factory _$BankTransactionEntityPaymentData(
      ...
      (new BankTransactionEntityPaymentDataBuilder()..update(updates))._build();

  _$BankTransactionEntityPaymentData._(
      {required this.id,
  ...
  @override
  BankTransactionEntityPaymentData rebuild(
          void Function(BankTransactionEntityPaymentDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BankTransactionEntityPaymentDataBuilder toBuilder() =>
      new BankTransactionEntityPaymentDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BankTransactionEntityPaymentData &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BankTransactionEntityPaymentData')
          ..add('id', id)
...
class BankTransactionEntityPaymentDataBuilder
    implements
        Builder<BankTransactionEntityPaymentData,
            BankTransactionEntityPaymentDataBuilder> {
  _$BankTransactionEntityPaymentData? _$v;
  ...
  BankTransactionEntityPaymentDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(BankTransactionEntityPaymentData other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$BankTransactionEntityPaymentData;
  }

  @override
  void update(void Function(BankTransactionEntityPaymentDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BankTransactionEntityPaymentData build() => _build();

  _$BankTransactionEntityPaymentData _build() {
    final _$result = _$v ??
        new _$BankTransactionEntityPaymentData._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'BankTransactionEntityPaymentData', 'id'),
            transactionId: BuiltValueNullFieldError.checkNotNull(transactionId,
                r'BankTransactionEntityPaymentData', 'transactionId'),
            payerName: payerName,
